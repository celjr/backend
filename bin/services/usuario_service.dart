...
class UsuarioService implements GenericService<UsuarioModel> {
  ...
  @override
  Future<bool> delete(int id) => _usuarioDAO.delete(id);

  @override
  Future<List<UsuarioModel>> findAll() => _usuarioDAO.findAll();

  @override
  Future<UsuarioModel?> findOne(int id) => _usuarioDAO.findOne(id);
